...
export default function Projects({}: Props) {
  ...
  return (
    <div className="h-screen  max-w-full mx-auto flex flex-col items-center justify-center overflow-hidden z-0">
      <div className="flex  w-full overflow-x-scroll overflow-y-scroll snap-x snap-mandatory z-20">
        {project.map((project) => (
          <div className="w-screen flex-shrink-0 snap-center  flex flex-col items-center justify-center space-y-8  p-20 md:p-44 h-screen">
            <img
            ...
            <div className=" max-w-6xl">
              <h3 className="text-4xl text-center uppercase">hlo i am yash </h3>
            </div>
